...
#include <Source/GameLiftDemoTypes.h>
...
namespace GameLiftDemo
{
    ...
    //! Status states for a GameLiftDemo weapon.
    ...
    struct GatherParams
    {
        AZ_TYPE_INFO(GatherParams, "{5A651D7A-54D8-4FFD-8D35-7A3EC83D6719}");
    ...
    struct HitEffect
    {
        AZ_TYPE_INFO(HitEffect, "{B6A5E745-5D34-402A-82CE-9351BA261210}");
    ...
    struct WeaponParams
    {
        AZ_TYPE_INFO(WeaponParams, "{78875557-BB0E-417B-8F99-35BA79DE24FC}");
    ...
    struct HitEntity
    {
        AZ_TYPE_INFO(HitEntity, "{4167E2BF-C0EF-4533-B971-27B7DFC5EDC8}");
    ...
    struct HitEvent
    {
        AZ_TYPE_INFO(HitEvent, "{F7C12FD7-5A10-49A5-A438-4316DDDDE7BA}");
...
namespace AZ
{
    AZ_TYPE_INFO_SPECIALIZE(GameLiftDemo::WeaponType, "{E51D2FF0-E12B-459A-9706-2499F109116A}");
    AZ_TYPE_INFO_SPECIALIZE(GameLiftDemo::WeaponStatus, "{00B997D9-FD02-42DD-A141-CE60073E3A1C}");
    AZ_TYPE_INFO_SPECIALIZE(GameLiftDemo::GatherShape, "{A54B042F-945D-42EF-9127-BC61A218FD5E}");
    AZ_TYPE_INFO_SPECIALIZE(GameLiftDemo::GatherDirection, "{E1F25FD0-12B2-41CE-9C38-2670873B6E4A}");
    AZ_TYPE_INFO_SPECIALIZE(GameLiftDemo::EffectDirection, "{9724A06D-335D-4CE4-B3E9-AFC5AD1B093F}");
}

AZ_TYPE_SAFE_INTEGRAL_SERIALIZEBINDING(GameLiftDemo::WeaponIndex);
