...
namespace GameLiftDemo
{
    ...
    void ReflectWeaponEnums(AZ::ReflectContext* context)
    {
        ...
        if (serializeContext)
        {
            ...
            if (editContext)
            {
                editContext->Enum<SoundEffect>("SoundEffect", "Valid sound effects to use within GameLiftDemo")
                ...
                editContext->Enum<CharacterAnimState>("CharacterAnimState", "Various GameLiftDemo character animation states")
                ...
                editContext->Enum<WeaponType>("WeaponType", "Different weapon types in GameLiftDemo")
                    ->Value("None", WeaponType::None)
                    ->Value("Trace", WeaponType::Trace)
                    ->Value("Projectile", WeaponType::Projectile);

                editContext->Enum<WeaponStatus>("WeaponStatus", "Status states for a GameLiftDemo weapon")
    ...
    void HitEntity::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (behaviorContext)
        {
            behaviorContext->Class<HitEntity>("HitEntity")
                ...
                ->Attribute(AZ::Script::Attributes::Module, "GameLiftDemo")
                ->Attribute(AZ::Script::Attributes::Category, "GameLiftDemo")
                ->Constructor<>()
